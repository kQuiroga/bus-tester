...
export class HlmDialogContent {
	...
	constructor() {
		classes(() => [
			'bg-popover text-popover-foreground ring-foreground/10 relative mx-auto grid w-full max-w-[calc(100%-2rem)] gap-6 rounded-xl p-6 text-sm ring-1 outline-none sm:mx-0 sm:max-w-md',
